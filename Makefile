...
#main.o game.o gba.o images/TitleScreen.o images/FinalScoreScreen.O images/GameOverScreen.o images/apple.o images/bananas.o images/orange.o images/grapes.o images/pear.o images/bomb.o images/basket.o
################################################################################
